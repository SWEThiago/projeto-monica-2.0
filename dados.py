...
def remover_vendedor(dados, vendedor_id):
    return [vendedor for vendedor in dados if vendedor['id'] != vendedor_id]
...
def obter_todos_vendedores(dados):
...
def obter_leads_por_periodo(dados, vendedores_selecionados, inicio_str, fim_str):
